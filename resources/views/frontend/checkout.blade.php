...
<div class="container">
    ...
    <div class="alert alert-success alert-dismissible fade show shadow mb-5 mt-5" role="alert">
        {{session('success')}}
    ...
    <div class="alert alert-danger alert-dismissible fade show shadow mb-5 mt-5" role="alert">
        {{session('error')}}
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
      </div>
    @endif   
